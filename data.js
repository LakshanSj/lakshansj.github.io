 ...
 * Default configuration and dynamic data store for Lakshan Jayawardana's Portfolio.
 */
...
const defaultPortfolioData = {
    ...
    about: {
        ...
        stats: [
            { label: "Current SGPA", value: "3.74" },
            { label: "A/L Physical Science", value: "3As" },
    ...
    skills: [
        {
            ...
            items: ["Python", "Java", "C++", "React.js", "Basic Web Development", "Database Management", "SQL"]
        },
        {
            id: "skill-cat-2",
            category: "Hardware & Systems",
            icon: "fa-solid fa-microchip",
            items: ["VHDL", "BASYS 3 FPGA", "Digital Circuit Design", "Vivado", "VS Code", "Git & GitHub"]
        },
        {
            id: "skill-cat-3",
            category: "Communication & Tools",
            icon: "fa-solid fa-language",
            items: ["Sinhala (Native Fluency)", "English (Professional)", "Microsoft Word", "Microsoft Excel", "PowerPoint"]
        }
    ],
    projectCategories: [
        { key: "all", label: "All" },
    ...
    projects: [
        {
            ...
            tags: ["FastAPI", "React", "LSTM", "ARIMA", "LightGBM", "Financial Data"],
        ...
        },
        {
            ...
            tags: ["React", "Flask", "HTML/CSS", "JavaScript", "MySQL", "Voice-to-Text"],
        ...
        },
        {
            ...
            tags: ["VHDL", "Vivado", "BASYS 3 FPGA", "Digital Design"],
        ...
        },
        {
            ...
            tags: ["IoT Sensors", "Solar Energy", "ESP32", "Mobile Integration", "Firebase"],
...
function getPortfolioData() {
    try {
        ...
        if (local) {
            ...
            // Merge defaults with saved data to ensure backwards compatibility
            return {
        ...
        console.warn('Failed to load portfolio data from localStorage, falling back to default:', e);
    }
